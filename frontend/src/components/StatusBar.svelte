...
<div class="flex items-center gap-4 flex-1">
  <div class="flex items-baseline gap-0 font-mono text-[22px] font-semibold text-success tracking-wider">
    ...
    <span class="text-[13px] text-base-content/50 ml-1 font-normal">MHz</span>
  </div>
  ...
  <div class="flex items-center gap-1.5">
    ...
    <span class="text-[13px] font-semibold {s.tx ? 'text-error' : 'text-success'}">{s.tx?'TX':'RX'}</span>
  </div>
  <div class="ml-auto flex gap-3 font-mono text-[13px] text-base-content/60">
