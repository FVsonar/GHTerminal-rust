...
pub const CTCSS_TABLE: [f32; 56] = [
    0.0, 67.0, 69.3, 71.9, 74.4, 77.0, 79.7, 82.5, 85.4, 88.5, 91.5, 94.8, 97.4, 100.0, 103.5,
    ...
    199.5, 203.5, 206.5, 210.7, 213.8, 218.1, 221.3, 225.7, 229.1, 233.6, 237.1, 241.8, 245.5,
    250.3, 254.1,
];

/// 前导音定义 (5.20)
pub const LEAD_TONES: [(u8, f32); 3] = [(0, 0.0), (1, 1750.0), (2, 2135.0)];
